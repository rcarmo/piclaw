...
export const REQUIRED_PACK_ENTRIES = [
  ...
  "runtime/skills/integrations/cdp-browser-vnc-setup/check.ts",
  "runtime/scripts/managed-cdp-browser-vnc-smoke.ts",
  "runtime/scripts/vendor-xterm.ts",
  "runtime/vendor-manifests/xterm.json",
  "runtime/web/static/common/js/vendor/xterm/xterm.meta.json",
  "skel/AGENTS.md",
